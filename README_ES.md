...
1. Filtrado Estadístico Rápido ($Z$-score): Analiza el 100% de los envíos con latencia inferior a un milisegundo sin incurrir en costos de inferencia LLM.
...
Restricción de Costo Cero: Construido sin entrenamiento de modelos y sin APIs de pago.

---

## Despliegue en Producción

- Aplicación Web Global: https://bharatflow-ai-nvbz.onrender.com
- Endpoint de Estado: https://bharatflow-ai-nvbz.onrender.com/api/status
...
3. Diseño Visual DHL (Sin Emojis): Paleta corporativa balanceada 60-30-10 (`#FFFFFF`, `#242832`, `#D40511`, `#FFCC00`) con gráficos vectoriales SVG nativos.
